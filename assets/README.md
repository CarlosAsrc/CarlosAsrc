...
- Technology logos: [Devicon](https://github.com/devicons/devicon), copied September 5, 2026. The inspected source tree was `7330accdbc47e2dc0c19789a48533c4a3c50fe58`. Original license: `brands/LICENSE` (MIT). Kafka is recolored in the generated timeline for contrast; the source logo remains intact. Logos identify technologies, not endorsements.
